        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3" align="right">
                    <a href="?page=tambah-role" class="btn btn-primary">Add Major</a>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($rows as $key => $data): ?>
                                <tr>
                                    ...
                                    <td> <a href="?page=tambah-role&edit=<?php echo $data['id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                                        <a onclick="return confirm('Are you sure wanna delete this data??')"
                                            href="?page=role&delete=<?php echo $data['id'] ?>" class="btn btn-danger btn-sm">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
